...
final class Version20210406153828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE auction (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, seller_id INT NOT NULL, buyer_id INT DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_DEE4F5934584665A (product_id), INDEX IDX_DEE4F5938DE820D9 (seller_id), INDEX IDX_DEE4F5936C755722 (buyer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
